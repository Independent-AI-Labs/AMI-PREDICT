...
class ExperimentDB:
    ...
    def save_model_artifact(self, experiment_id: int, artifact_type: str, 
    ...
    def get_best_experiments(self, metric: str = 'sharpe_ratio', 
                           dataset: str = 'test', limit: int = 10) -> pd.DataFrame:
