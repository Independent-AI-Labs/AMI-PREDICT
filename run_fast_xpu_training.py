...
def create_sequences_fast(df, seq_len=50):
    ...
    features = ["returns", "log_returns", "hl_ratio", "volume_norm", "price_ma_ratio", "momentum_5", "momentum_10", "volatility", "price_position", "volume"]
...
def main():
    ...
    model = train_on_xpu(model, X_train, y_train, X_val, y_val, epochs=10, batch_size=batch_size)
